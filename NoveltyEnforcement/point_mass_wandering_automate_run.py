...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', help='environment ID', default='PointMassWandering-v0')
    ...
    parser.add_argument('--num_iterations', help='Number of iterations need to be run', default=200)

    parser.add_argument('--data_collect_env', help='Environment used to collect data', default='PointMassWandering-v0')
    ...
    parser.add_argument('--collect_policy_start', help='First policy used to collect trajectories', default=150)
