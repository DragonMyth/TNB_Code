...
class DartHumanoidSwimStraightFullEnforceEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
    ...
    def init_nec_params(self):
        ...
        self.recordGap = 3
        self.traj_buffer = []
        self.symm_autoencoder =  load_model("./AutoEncoder/DartHumanFullAutoencoder_1+2+3+4.h5")
...
class DartHumanoidSwimStraightFullReleaseEnv(DartHumanoidSwimStraightFullEnforceEnv):
    def __init__(self):
